                    ...
                    <div className="my-4">
                        ...
                        <Modal open={open} onClose={handleClose} aria-labelledby="modal-modal-title"
                            ...
                            <Box sx={style}>
                                ...
                                <Typography variant="subtitle1" className="font-normal" > Meme Bets ($MBETS) is the future of online gambling, where the thrill of casino games meets the excitement of cryptocurrency. As the flagship token of our cutting-edge crypto online casino, $MBETS allows you to embark on a thrilling journey through a world of bets and memes.
                                </Typography>
                                <br></br>
                                <br></br>
                                <Typography variant="subtitle1" className="font-normal" >
